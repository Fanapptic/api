...
const networkUserAttachmentsRouter = rootRequire('/routes/network/users/attachments');
...
module.exports = app => {
  ...
  app.use('/networks/fanapptic/users/:networkUserId/attachments/:networkUserAttachmentId?', networkUserAttachmentsRouter);
